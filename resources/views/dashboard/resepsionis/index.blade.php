...
@php
    ...
    $user = Auth::user();
    $nama = $user->nama ?? $user->name ?? 'Resepsionis';
  ...
  <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col md:flex-row items-center justify-between gap-6">
          <div class="text-white text-center md:text-left">
            ...
            <p class="text-teal-100 text-lg leading-relaxed max-w-2xl">
              Selamat datang di <span class="font-bold text-white">Portal Resepsionis RSHP Universitas Airlangga</span>.<br>
              Kelola pendaftaran pemilik & hewan, serta penjadwalan temu dokter dengan cepat dan terorganisir.
            </p>
          </div>
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
      ...
      <a href="{{ route('resepsionis.temu-dokter.index') }}" 
        ...
        <div class="flex items-start justify-between mb-6">
          ...
          <div class="bg-blue-100 px-3 py-1 rounded-full">
            <span class="text-blue-800 text-xs font-bold">JADWAL</span>
          </div>
        </div>
        ...
        <p class="text-gray-600 mb-4 leading-relaxed">
          Kelola jadwal temu dokter untuk pemilik dan hewan.
        </p>
      ...
      <a href="{{ route('resepsionis.registrasi-pemilik.create') }}" 
        ...
        <div class="flex items-start justify-between mb-6">
          <div class="bg-gradient-to-br from-emerald-500 to-emerald-600 p-4 rounded-2xl shadow-lg group-hover:scale-110 transition-transform duration-300">
            <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
            </svg>
          </div>
          <div class="bg-emerald-100 px-3 py-1 rounded-full">
            <span class="text-emerald-800 text-xs font-bold">PEMILIK</span>
          </div>
        </div>
        ...
        <p class="text-gray-600 mb-4 leading-relaxed">
          Tambahkan data pemilik hewan baru dengan cepat dan rapi.
        </p>
        
        <div class="flex items-center gap-2 text-emerald-600 font-semibold group-hover:gap-4 transition-all">
      ...
      <a href="{{ route('resepsionis.registrasi-pet.create') }}" 
        ...
        <div class="flex items-start justify-between mb-6">
          <div class="bg-gradient-to-br from-teal-500 to-teal-600 p-4 rounded-2xl shadow-lg group-hover:scale-110 transition-transform duration-300">
            <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7a4 4 0 014-4h1a3 3 0 013 3v1h2a4 4 0 014 4v1a3 3 0 01-3 3h-1v2a3 3 0 01-3 3H9a4 4 0 01-4-4V7z"/>
            </svg>
          </div>
        ...
        <p class="text-gray-600 mb-4 leading-relaxed">
          Daftarkan hewan milik pemilik untuk kebutuhan layanan RSHP.
        </p>
    ...
    <div class="grid md:grid-cols-2 gap-6 mb-8">
      ...
      <div class="glass rounded-3xl p-8 shadow-xl border border-white animate-fadeIn delay-400">
        ...
        <div class="space-y-3">
          <a href="{{ route('resepsionis.temu-dokter.index') }}" 
            ...
            <div class="flex-1">
              <p class="font-bold text-gray-900">Kelola Temu Dokter</p>
              <p class="text-sm text-gray-600">Lihat & atur jadwal temu dokter.</p>
            </div>
          ...
          <a href="{{ route('resepsionis.registrasi-pemilik.create') }}" 
             class="flex items-center gap-4 p-4 bg-gradient-to-r from-emerald-50 to-green-50 rounded-xl border border-emerald-100 hover:shadow-md transition-all group">
            ...
            <div class="flex-1">
              <p class="font-bold text-gray-900">Registrasi Pemilik Baru</p>
              <p class="text-sm text-gray-600">Input data pemilik hewan baru.</p>
            </div>
            <svg class="w-5 h-5 text-emerald-600 group-hover:translate-x-2 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
            </svg>
          </a>
          ...
          <a href="{{ route('resepsionis.registrasi-pet.create') }}" 
            ...
            <div class="flex-1">
              <p class="font-bold text-gray-900">Registrasi Pet Baru</p>
              <p class="text-sm text-gray-600">Tambahkan data hewan milik pemilik.</p>
            </div>
      ...
      <div class="glass rounded-3xl p-8 shadow-xl border border-white animate-fadeIn delay-500">
        <div class="flex items-center gap-3 mb-6">
          ...
          <h2 class="text-2xl font-black gradient-text">Tips Layanan</h2>
        </div>
        ...
        <div class="space-y-4">
          <div class="flex items-start gap-3">
            ...
            <div>
              <p class="font-semibold text-gray-900 mb-1">Verifikasi Data</p>
              <p class="text-sm text-gray-600">Pastikan data pemilik dan pet lengkap sebelum menyimpan.</p>
            </div>
          </div>
          ...
          <div class="flex items-start gap-3">
            ...
            <div>
              <p class="font-semibold text-gray-900 mb-1">Konfirmasi Jadwal</p>
              <p class="text-sm text-gray-600">Sampaikan jam temu dokter dengan jelas kepada pemilik.</p>
            </div>
          </div>
          ...
          <div class="flex items-start gap-3">
            ...
            <div>
              <p class="font-semibold text-gray-900 mb-1">Pelayanan Ramah</p>
              <p class="text-sm text-gray-600">Berikan sapaan hangat dan informasi dengan bahasa yang mudah dipahami.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="flex items-center justify-between flex-wrap gap-4">
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-sm text-gray-600">Hubungi admin atau customer service RSHP</p>
          </div>
        </div>
