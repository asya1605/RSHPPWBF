...
@php
  // Biar konsisten sama halaman lain yang pakai $showDeleted
      ...
      <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div>
          <div class="flex items-center gap-3 mb-3">
            ...
            <h1 class="text-3xl font-black gradient-text">Data Kode Tindakan Terapi</h1>
          </div>
          <p class="text-gray-600 leading-relaxed max-w-2xl">
            Kelola daftar kode tindakan terapi beserta kategori dan kategori klinis yang digunakan pada layanan RSHP UNAIR.
          </p>
        </div>
        ...
        <div class="flex flex-wrap gap-3">
          ...
          @else
            <a href="{{ route('admin.kode-tindakan-terapi.index', ['show_deleted' => 1]) }}"
               class="btn-danger">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8 animate-fadeIn delay-100">
      <div class="glass rounded-2xl p-6 shadow-xl border border-white">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-gray-600 text-sm mb-1">Total Kode</p>
            <p class="text-3xl font-black text-[#002080]">{{ count($data) }}</p>
          </div>
      ...
      <div class="glass rounded-2xl p-6 shadow-xl border border-white">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-lg font-bold text-gray-800">Kode & Kategori</p>
          </div>
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center gap-3">
                    <div class="bg-gradient-to-br from-blue-100 to-blue-200 px-3 py-1 rounded-lg">
                      <span class="text-sm font-bold text-blue-800">{{ $item->kode }}</span>
                    </div>
                  </div>
                </td>
                <td class="px-6 py-4">
                  ...
                  <div class="flex flex-col items-center gap-4">
                    ...
                    <div>
                      <p class="text-gray-600 font-semibold text-lg">
                        Belum ada data kode tindakan
                      </p>
                      <p class="text-gray-500 text-sm mt-1">
                        {{ $showDeleted ? 'Tidak ada kode tindakan yang terhapus' : 'Mulai tambahkan kode tindakan baru' }}
                      </p>
                    </div>
                  </div>
                </td>
      ...
      <div class="bg-gradient-to-r from-gray-50 to-blue-50 px-6 py-4 border-t border-gray-200">
        <div class="flex items-center justify-between">
          <p class="text-sm text-gray-600">
            Menampilkan
            <span class="font-bold text-[#002080]">{{ count($data) }}</span>
            kode tindakan {{ $showDeleted ? 'terhapus' : 'aktif' }}
          </p>
        </div>
      </div>
    </div>
