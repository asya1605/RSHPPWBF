  ...
  <div class="w-full max-w-3xl">
    ...
    <div class="mb-6 animate-slideDown">
      <div class="flex items-center gap-2 text-sm text-gray-600">
        ...
        <span class="text-[#002080] font-semibold">Tambah Kode</span>
      </div>
    </div>
    ...
    <div class="glass rounded-3xl shadow-2xl border border-white overflow-hidden animate-fadeIn">
      ...
      <div class="bg-gradient-to-r from-[#002080] to-[#0040A0] p-8">
        <div class="flex items-center gap-4">
          ...
          <div>
            <h2 class="text-2xl font-black text-white mb-1">Tambah Kode Tindakan Terapi</h2>
            <p class="text-blue-100 text-sm">
              Daftarkan kode tindakan terapi beserta deskripsi, kategori, dan kategori klinis.
            </p>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div class="grid md:grid-cols-2 gap-6">
          ...
          {{-- Kategori Klinis --}}
          <div class="form-group md:col-span-2 md:col-span-1">
            <label class="form-label">
              <svg class="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
