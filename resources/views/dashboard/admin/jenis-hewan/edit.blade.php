  ...
  <div class="w-full max-w-2xl">
    ...
    <div class="mb-6 animate-slideDown">
      <div class="flex items-center gap-2 text-sm text-gray-600">
        ...
        <span class="text-[#002080] font-semibold">Edit Jenis Hewan</span>
      </div>
    </div>
    ...
    <div class="glass rounded-3xl shadow-2xl border border-white overflow-hidden animate-fadeIn">
      ...
      <div class="bg-gradient-to-r from-amber-500 to-amber-600 p-8">
        <div class="flex items-center justify-between gap-4">
          <div class="flex items-center gap-4">
            ...
            <div>
              <h2 class="text-2xl font-black text-white mb-1">Edit Jenis Hewan</h2>
              <p class="text-amber-100 text-sm">
                Perbarui nama jenis hewan yang digunakan pada data ras dan pet.
              </p>
            </div>
          </div>
          ...
          <div class="hidden md:block">
            <div class="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-xl border border-white/30">
              <p class="text-amber-100 text-xs font-semibold mb-0.5">Jenis Hewan ID</p>
              <p class="text-white text-lg font-black">#{{ $jenis->idjenis_hewan }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="md:hidden mt-4">
          <div class="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-xl border border-white/30 inline-block">
            <span class="text-white text-sm font-bold">ID: #{{ $jenis->idjenis_hewan }}</span>
          </div>
        </div>
      </div>
      ...
      {{-- FORM --}}
      <form method="POST" action="{{ route('admin.jenis-hewan.update', $jenis->idjenis_hewan) }}" class="p-8 pt-4">
        @csrf
        @method('PUT')
        ...
        <div class="space-y-6">
          ...
          <div class="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl p-5 border border-blue-100">
            <div class="flex items-start gap-4">
              ...
              <div class="flex-1">
                <p class="font-bold text-gray-800 mb-2">Data Jenis Hewan Saat Ini:</p>
                <div class="grid md:grid-cols-2 gap-3 text-sm">
                  <div>
                    <p class="text-gray-600 mb-0.5">ID Jenis Hewan:</p>
                    <p class="font-semibold text-gray-900">#{{ $jenis->idjenis_hewan }}</p>
                  </div>
                  <div>
                    <p class="text-gray-600 mb-0.5">Nama Jenis:</p>
                    <p class="font-semibold text-gray-900">{{ $jenis->nama_jenis_hewan }}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="form-group">
            ...
            <p class="form-hint">
              Perbarui nama jenis hewan sesuai kebutuhan. Hindari penggunaan nama yang duplikat.
            </p>
            ...
            <div class="flex gap-3">
              ...
              <div class="text-sm text-amber-900">
                ...
                <ul class="space-y-1 text-amber-800">
                  <li>• Perubahan nama akan berdampak pada tampilan di data ras dan pet.</li>
                  <li>• Pastikan penulisan nama konsisten (misalnya kapital di awal).</li>
                </ul>
              </div>
            </div>
          </div>
