  ...
  <div class="w-full max-w-2xl">
    ...
    <div class="mb-6 animate-slideDown">
      <div class="flex items-center gap-2 text-sm text-gray-600">
        ...
        <span class="text-[#002080] font-semibold">Tambah Ras Hewan</span>
      </div>
    </div>
    ...
    <div class="glass rounded-3xl shadow-2xl border border-white overflow-hidden animate-fadeIn">
      ...
      <div class="bg-gradient-to-r from-[#002080] to-[#0040A0] p-8">
        <div class="flex items-center gap-4">
          ...
          <div>
            <h2 class="text-2xl font-black text-white mb-1">Tambah Ras Hewan</h2>
      ...
      {{-- FORM --}}
      <form method="POST" action="{{ route('admin.ras-hewan.store') }}" class="p-8 pt-4">
        @csrf

        <div class="space-y-6">
          {{-- Nama Ras --}}
          <div class="form-group">
            <label class="form-label" for="nama_ras">
          ...
          {{-- Jenis Hewan --}}
          <div class="form-group">
            <label class="form-label" for="idjenis_hewan">
              <svg class="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="flex gap-3">
              ...
              <div class="text-sm text-blue-800">
                ...
                <ul class="space-y-1 text-blue-700">
                  <li>• Pastikan ras sesuai dengan jenis hewan yang dipilih.</li>
                  <li>• Ras ini akan ditampilkan pada pilihan ras di data pet.</li>
                </ul>
              </div>
            </div>
          </div>
